...
# Comma-separated template variable fields.
# For the current approved seminar follow-up template, use:
# customer_name,seminar_date,seminar_time,arrival_time,venue
# If blank, the backend automatically uses the above 5 fields for non-hello_world templates.
